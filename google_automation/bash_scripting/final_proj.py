...
# cat syslog.log; grep ticky syslog.log; grep "ERROR" syslog.log; grep "ERROR Tried to add information to closed ticket" syslog.log
# grep -c "ERROR Tried to add information to closed ticket" syslog.log
